        ...
        <header class="mb-12">
            ...
            <div class="flex items-center gap-4">
                <div class="bg-primary/5 px-6 py-3 rounded-2xl border border-primary/10 flex items-center gap-3">
                    ...
                    <span class="text-xs font-black text-primary uppercase tracking-widest leading-none"><?php echo mysqli_num_rows($result); ?> Total Records</span>
                </div>
            </div>
        </header>
                            ...
                            <tr class="group/row hover:bg-slate-50/50 transition-all">
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex flex-col">
                                        <span class="font-black text-primary italic text-sm tracking-tight">#<?php echo $row['ticket_number']; ?></span>
                                        <span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1"><?php echo date('d M Y', strtotime($row['created_at'])); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex flex-col gap-1.5">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border w-fit
                                            <?php 
                                                if($row['status'] == 'Selesai') echo 'bg-emerald-50 text-maintenance border-emerald-100';
                                                elseif($row['status'] == 'Proses') echo 'bg-indigo-50 text-indigo-700 border-indigo-100';
                                                elseif($row['status'] == 'Ditolak') echo 'bg-error/5 text-error border-error-100';
