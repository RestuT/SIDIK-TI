...
$query = "SELECT s.*, u.full_name, u.jabatan, u.department 
          ...
          WHERE s.id = '$id' AND s.user_id = '$user_id' AND s.type = 'Pengadaan'";
...
<head>
    ...
    <title>Procurement Ticket - <?php echo $data['ticket_number']; ?></title>
    <!-- Fonts -->
    ...
    <div class="max-w-3xl mx-auto bg-white p-12 rounded-[3rem] shadow-2xl border border-outline-variant/10 print-card relative overflow-hidden">
        ...
        <div class="flex flex-col items-center border-b-2 border-dashed border-slate-100 pb-10 mb-10 relative z-10">
            ...
            <div class="mt-4 px-4 py-1.5 bg-slate-50 border border-slate-100 rounded-full">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Procurement Control: <span class="text-orange-600">#<?php echo $data['ticket_number']; ?></span></p>
            </div>
        </div>
