            ...
            <div class="bg-surface-container-lowest p-8 rounded-3xl shadow-sm border border-transparent hover:border-primary/10 transition-all duration-500 group">
                <div class="flex justify-between items-start mb-6">
                    <div class="p-4 bg-indigo-50 text-indigo-600 rounded-2xl group-hover:scale-110 transition-transform duration-300">
                        <span class="material-symbols-outlined text-3xl" data-icon="sync">sync</span>
                    </div>
                            ...
                            <tr class="group hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-6">
                                    <?php 
                                        ...
                                        if($row['status'] == 'Menunggu') { $statusClass = "bg-orange-50 text-orange-700 border-orange-100/50"; $dotClass = "bg-orange-500 animate-pulse"; }
                                        elseif($row['status'] == 'Proses') { $statusClass = "bg-blue-50 text-blue-700 border-blue-100/50"; $dotClass = "bg-blue-500"; }
                                        elseif($row['status'] == 'Selesai') { $statusClass = "bg-emerald-50 text-emerald-700 border-emerald-100/50"; $dotClass = "bg-emerald-500"; }
                                        elseif($row['status'] == 'Dibatalkan' || $row['status'] == 'Ditolak') { $statusClass = "bg-rose-50 text-rose-700 border-rose-100/50"; $dotClass = "bg-rose-500"; }
                                    ?>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-8 pb-10">
            <div class="relative overflow-hidden rounded-3xl p-10 bg-indigo-900 text-white min-h-[300px] flex flex-col justify-end">
                <div class="absolute top-0 right-0 p-8 opacity-20">
                    <span class="material-symbols-outlined text-[120px]" data-icon="tips_and_updates">tips_and_updates</span>
                </div>
