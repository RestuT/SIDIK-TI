...
$query = "SELECT s.*, u.full_name, u.jabatan, u.department 
          ...
          WHERE s.id = '$id' AND s.user_id = '$user_id' AND s.type = 'Maintenance'";
...
<head>
    ...
    <title>Maintenance Ticket - <?php echo $data['ticket_number']; ?></title>
    <!-- Fonts -->
    ...
    <div class="max-w-3xl mx-auto bg-white p-12 rounded-[3rem] shadow-2xl border border-outline-variant/10 print-card relative overflow-hidden">
        ...
        <div class="flex flex-col items-center border-b-2 border-dashed border-slate-100 pb-10 mb-10 relative z-10">
            ...
            <div class="mt-4 px-4 py-1.5 bg-slate-50 border border-slate-100 rounded-full">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Official Ticket: <span class="text-primary">#<?php echo $data['ticket_number']; ?></span></p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-xs font-medium text-slate-500 mt-1"><?php echo htmlspecialchars($data['jabatan'] ?? 'Personnel'); ?></p>
                </div>
                <div>
            ...
            <div class="flex flex-col md:items-end justify-center">
                <div class="p-6 bg-slate-50 rounded-3xl border border-slate-100 w-full md:w-fit text-center">
                    ...
                    <p class="text-sm font-black text-slate-800 tracking-tight leading-none italic uppercase">
                        ...
                        <span class="block text-[10px] text-slate-400 mt-1 not-italic font-bold tracking-widest"><?php echo date('H:i:s P', strtotime($data['created_at'])); ?></span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-8 mb-12">
            ...
            <div class="space-y-3">
                ...
                <div class="rounded-3xl overflow-hidden border border-slate-200 shadow-sm transition-transform hover:scale-[1.01]">
                    <img src="<?php echo $data['attachment_path']; ?>" alt="Foto Kerusakan" class="w-full h-auto object-cover max-h-80 grayscale-[0.2] hover:grayscale-0 transition-all">
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="border-t-2 border-dashed border-slate-100 pt-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
                <div class="text-center md:text-left space-y-4">
                    ...
                    <div class="w-24 h-24 bg-surface rounded-2xl flex items-center justify-center border border-slate-100 mx-auto md:mx-0 group overflow-hidden">
                        <?php 
                            $qr_content = "SIDIK-TI VERIFICATION\n" .
                    ...
                    <p class="text-[10px] font-bold text-slate-300 italic">Digitally Signed by SIDIK-TI Engine</p>
                </div>
                <div class="flex flex-col md:items-end justify-center">
