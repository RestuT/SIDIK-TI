...
if (isset($_POST['save_profile'])) {
    ...
    // Update Dasar
    $update_sql = "UPDATE users SET full_name = '$full_name', username = '$username' WHERE id = '$user_id'";
...
$current_admin = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM users WHERE id = '$user_id'"));

// Fallbacks for Branding (System Settings are still needed for Logo/Brand)
$settings = [];
$get_settings = mysqli_query($conn, "SELECT * FROM system_settings");
